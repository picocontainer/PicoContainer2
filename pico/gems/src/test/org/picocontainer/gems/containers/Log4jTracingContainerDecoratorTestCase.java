...
public class Log4jTracingContainerDecoratorTestCase extends MockObjectTestCase {
	...
	public void testGetComponentAdapter() {
		ConstructorInjector testAdapter = new ConstructorInjector(String.class, String.class, null, new NullComponentMonitor(), new NullLifecycleStrategy(), false);
	...
	public void testRegisterComponent() {
		...
		ComponentAdapter result = tracingDecorator.addAdapter(testAdapter).getComponentAdapter(String.class, (ParameterName) null);
	...
	public void testRegisterComponentInstanceWithKey() {
		...
		ComponentAdapter testAdapter = new InstanceAdapter(String.class, testString, new NullLifecycleStrategy(),
	...
	public void testRegisterComponentImplementationObjectClassParameterArray() {
		...
		ConstructorInjector testAdapter = new ConstructorInjector(String.class, String.class, params, new NullComponentMonitor(), new NullLifecycleStrategy(), false);
