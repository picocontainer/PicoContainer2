...
public abstract class AbstractMultipleConstructorTest {
    ...
    @Test public void testMultiWithTwoEquallyBigSatisfiedDependenciesFails() throws PicoException {
        ...
        try {
            ...
            assertEquals("3 satisfiable constructors is too many for 'class org.picocontainer.tck.AbstractMultipleConstructorTest$Multi'. Constructor List:[<init>(org.picocontainer.tck.AbstractMultipleConstructorTest$Two,org.picocontainer.tck.AbstractMultipleConstructorTest$One), <init>(org.picocontainer.tck.AbstractMultipleConstructorTest$One,org.picocontainer.tck.AbstractMultipleConstructorTest$Two), <init>()]",
                    e.getMessage());
        }
    }
