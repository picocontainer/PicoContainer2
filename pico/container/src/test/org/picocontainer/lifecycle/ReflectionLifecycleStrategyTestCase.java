		...
		mockery.checking(new Expectations() {
			{
				...
				one(componentMonitor).invoked(with(aNull(PicoContainer.class)),
                        ...
                        with(any(Long.class)), with(any(Object[].class)), with(aNull(Object.class)));
			...
			mockery.checking(new Expectations() {
				{
					...
					one(componentMonitor).invoked(
							with(aNull(PicoContainer.class)),
							with(aNull(ComponentAdapter.class)),
							with(isStopMethod), with(same(mock)), with(any(Long.class)), with(any(Object[].class)), with(aNull(Object.class)));
				}
			});
			return mock;
		}
